...
describe("date tests", () => {
  ...
  test.each([
    ...
    [new Date(2024, 0, 2), new Date(2024, 0, 2)],
    [new Date(2024, 0, 3), new Date(2024, 0, 3)],
    [new Date(2024, 0, 4), new Date(2024, 0, 4)],
    [new Date(2024, 0, 5), new Date(2024, 0, 5)],
    [new Date(2024, 0, 6), new Date(2024, 0, 8)], // Weekend
    [new Date(2024, 0, 7), new Date(2024, 0, 8)], // Weekend
    [new Date(2024, 0, 8), new Date(2024, 0, 8)],
    [null as unknown as Date, null],
    [undefined as unknown as Date, undefined],
    [42 as unknown as Date, 42],
    ["test" as unknown as Date, "test"],
  ])("getNextBusinessDate", (date, expected) => {
    expect(getNextBusinessDate(date)).toEqual(expected);
  });
});
